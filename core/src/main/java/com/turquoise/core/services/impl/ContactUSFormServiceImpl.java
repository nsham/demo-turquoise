...
import com.turquoise.core.models.Contact;
...
import com.turquoise.core.services.ContactService;
...
@Component(immediate = true, service = ContactUSFormService.class
        , configurationPid = "com.turquoise.core.services.impl.ContactUSFormServiceImpl")
