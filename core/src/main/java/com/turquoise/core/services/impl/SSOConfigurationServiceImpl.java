 ...
 *                
 */
@Component(immediate = true, service = SSOConfigurationService.class, configurationPid = "com.turquoise.core.services.SSOConfigurationDetails")
...
public class SSOConfigurationServiceImpl implements SSOConfigurationService{
	...
	@ObjectClassDefinition(name = "turquoise SSO Configuration")
	...
	final static String SSO_PID ="com.turquoise.core.services.SSOConfigurationDetails";
	/*
