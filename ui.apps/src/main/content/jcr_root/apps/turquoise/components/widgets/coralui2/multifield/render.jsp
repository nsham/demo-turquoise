...
attrs.addOthers(cfg.getProperties(), "id", "rel", "class", "title", "fieldLabel", "fieldDescription", "renderReadOnly");
...
%><div <%= attrs.build() %>><%
    ...
    %><ol class="coral-Multifield-list js-coral-Multifield-list limit-multifield"></ol>
